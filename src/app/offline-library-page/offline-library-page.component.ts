...
@Component({
    selector: 'app-offline-library-page',
    templateUrl: './offline-library-page.component.html',
    styleUrls: ['./offline-library-page.component.scss']
})
export class OfflineLibraryPageComponent implements OnInit {
